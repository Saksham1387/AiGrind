...
const HeroSection: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 mt-[-170px]">
      <div className="text-center max-w-3xl font-medium">
        <h1 className="text-6xl font-medium text-gray-900 leading-tight">
          Welcome to{" "}
          <span className="underline decoration-2 underline-offset-8 decoration-blue-500">
            AIgrind
          </span>
        </h1>
