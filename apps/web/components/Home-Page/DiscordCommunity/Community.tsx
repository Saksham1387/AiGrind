    ...
    <div className="flex flex-col items-center justify-center w-full p-6 relative my-[150px]">
      ...
      <div className="text-center mt-6">
        ...
        <div className="flex justify-center w-full">
          <button className="flex  bg-purple items-center bg-purple-600 text-white font-semibold py-4 px-8 rounded-lg hover:bg-purple-600/90 focus:outline-none focus:ring-2 focus:ring-blue-500 ml-2">
            <Image
