...
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger } from "../../../packages/ui/src/@/components/ui/dropdown-menu";
...
export function Appbar() {
    ...
    <header className="bg-black text-white px-4 md:px-6 py-3 flex items-center justify-between">
      ...
      <nav className="hidden md:flex items-center gap-6">
        ...
        <Link href="/mentors" className="hover:underline" prefetch={false}>
          <Button className="bg-white text-black hover:bg-slate-200">1:1 Mentorship</Button>
        </Link>
      </nav>
  ...
  <AvatarImage src={userImage ? userImage : "https://github.com/shadcn.png"} />
  ...
  <DropdownMenuSeparator />
          ...
          <DropdownMenuLabel onClick={() => signOut()} className="hover:cursor-pointer hover:bg-slate-600">Log Out</DropdownMenuLabel>
